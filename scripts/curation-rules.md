...
**중요**: Slot 4는 한국 매체에 배타적으로 할당된다. 다음 상황에서도 한국 슬롯은 보존한다:

- **★★★ 풀이 5건 이상**이어도 Slot 1~3·5만 ★★★으로 채우고 Slot 4는 한국 매체에 양보
- **★★★ 풀이 6건 이상**이어도 마찬가지 — 비한국 ★★★ 1건을 떨어뜨리고 한국 ★★/★를 Slot 4에 배치
- 단, 한국 매체 ★★★이 풀에 있으면 자연스럽게 Slot 1~3 안에 들어가므로 Slot 4 보장 불필요 — 이때만 Slot 4를 다양성 슬롯으로 전환
- 한국 매체 기사가 그날 0건일 때만 Slot 4 생략 가능

**판단 예시**:
- 풀에 ★★★ 6건(비한국) + ★★ 한국 1건 → Top 5: 비한국 ★★★ 3건 + 한국 ★★ 1건 + ★★★ 1건 = 5건. (★★★ 6→4건으로 1건 떨어짐)
- 풀에 ★★★ 6건(비한국) + 한국 매체 0건 → Top 5: 비한국 ★★★ 5건. (Slot 4 다양성 슬롯 전환)
- 풀에 ★★★ 3건(중 한국 매체 1건) + ★★ 한국 1건 → Top 5: ★★★ 3건(한국 포함) + Slot 4·5는 ★★ 다양성 + 잔여 한국 ★★ 자연 포함 가능

**의도**: 한국 사용자가 매일 한국 핀테크 이슈를 Top 5에서 빠지지 않고 보도록 보장.
